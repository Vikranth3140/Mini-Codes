...
public class practice_make_library_solutions{
    static String[] availableBooks = {"Geeta", "Ramayana", "Gitanjali", "Constitution", "Godan", "Madhusala", "Nirmala", "Rashmirathi", "Pinjar", "Tamas"};
